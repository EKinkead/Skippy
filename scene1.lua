...
function scene:show( event )
    ...
    elseif phase == "did" then
        ...
        local FrogImage = display.newImage( "Images/frog01.png" )

        -- position the image
        FrogImage:translate( 100, 100 )

        -- tint the image red
        FrogImage:setFillColor( 1, 0, 0 )

        -- hide the image
        FrogImage.isVisible = false

        -- remove the image
        FrogImage:removeSelf()
        FrogImage = nil
